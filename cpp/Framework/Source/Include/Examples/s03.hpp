...
*/
//@see @ref page_ex03
#ifndef __EXAMPLES_S03_HPP_
#define __EXAMPLES_S03_HPP_
...
{
    typedef s00::Application Base; ///< @brief The base class.
protected:
...
inline void main(int argc, const char* argv[])
{
    log::Logger::root().setTarget(log::Target::Tie::create(
        log::Target::File::create("s03.log"),
...
@example Examples/s03.hpp
*/

#endif // __EXAMPLES_S03_HPP_
