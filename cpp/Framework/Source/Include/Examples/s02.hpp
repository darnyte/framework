...
@see @ref page_ex02
*/
#ifndef __EXAMPLES_S02_HPP_
#define __EXAMPLES_S02_HPP_
...
{
    { // configure logging
        log::Target::SharedPtr log_file = log::Target::File::create("s02.log");
...
The full source code available in Examples/s02.hpp file.
...
Application is a console program and it's reperented by an instance of s02::Application.
This instance can be created using s02::Application::create() factory method.
Application does all its useful work in s02::Application::run() method.
...
Once we got registration response we register our device on the server using s02::Application::asyncRegisterDevice() method.

If registration is successful we start listening for commands from the DeviceHive server using s02::Application::asyncPollCommands() method.
...
@example Examples/s02.hpp
*/

#endif // __EXAMPLES_S02_HPP_
